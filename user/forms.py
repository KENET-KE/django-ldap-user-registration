...
class UserRegisterForm(forms.Form):
    ...
    organization = forms.ChoiceField(required=True, choices=())
    username = forms.CharField(required=True, max_length=100)#, validators=)
    ...
    country = forms.ChoiceField(required=True, choices=())  # Set to default to your country
